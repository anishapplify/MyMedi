//
//  EmergencyDetailsViewController.m
//  MyMedi_Version2
//
...
@interface EmergencyDetailsViewController (){
    UIView *headerView;
    UILabel *headerLabel;
    UIButton *backButton;
    UIButton *editButton;
...
@implementation EmergencyDetailsViewController
...
- (void)viewDidLoad
{
    ...
    headerLabel.text= @"Employment Details";
...
#pragma mark FIRST NAME
    ...
    firstNameLabel.text= @"   Employment Contact Name";
...
#pragma mark LAST NAME
    ...
    lastNameLabel.frame = CGRectMake(0, firstNameTextField.frame.size.height+firstNameTextField.frame.origin.y+0.5, 320, 20);
    ...
    lastNameLabel.text= @"   Employment Contact Address";
    ...
    lastNameTextField.placeholder = @"Enter address";
...
#pragma mark DOB
    ...
    DOBLabel.text= @"   Employment Contact Telephone";
    ...
    dobTextField.placeholder = @"Enter number";
...
#pragma mark Gender
    ...
    GenderLabel.text= @"   Employment Contact Email";
    ...
    GenderTextField.placeholder = @"Enter email";
...
#pragma mark Marital Status
    ...
    maritalStatusLabel.text= @"   Employment Contact Relationship";
    ...
    maritalStatusTextField.placeholder = @"Enter relationship";
