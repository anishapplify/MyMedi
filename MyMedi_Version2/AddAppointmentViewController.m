...
-(void)ProviderAction
{
    ProviderViewController *providerview=[[ProviderViewController  alloc]init];
...
{
    AttachmentsViewController *attachments=[[AttachmentsViewController  alloc]init];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    TypeTitleLable.text=[[NSUserDefaults standardUserDefaults]valueForKey:@"setTypeValueSelect"];
    ...
    ProviderTitleLable.text=[[NSUserDefaults standardUserDefaults]valueForKey:@"setProviderValueSelect"];
