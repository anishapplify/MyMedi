//
//  MedicalProviderViewController.m
//  MyMedi_Version2
//
...
#import "MedicalProviderViewController.h"

@interface MedicalProviderViewController (){
...
@implementation MedicalProviderViewController
...
- (void)viewDidLoad
{
    ...
    NewAppointmentLable.text=@"Providers";
    ...
    ProviderTableView=nil;
    ProviderTableView=[[UITableView alloc]init];
    ProviderTableView.frame=CGRectMake(0, TopBarView.frame.size.height+TopBarView.frame.origin.y,320 , 500);
    ProviderTableView.backgroundColor=[UIColor clearColor];
    ProviderTableView.delegate=self;
    ProviderTableView.dataSource = self;
    ProviderTableView.showsVerticalScrollIndicator=NO;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [CellButtonClick setTitle:[NSString stringWithFormat:@"%d",[[[[[[[NSUserDefaults standardUserDefaults]objectForKey:kLoginData] objectForKey:@"appointment"] objectForKey:@"appointment_provider"]valueForKey:@"id"] objectAtIndex:indexPath.row] integerValue]] forState:UIControlStateNormal];
    ...
    JobTitleNameShow.text = [[[[[[NSUserDefaults standardUserDefaults]objectForKey:kLoginData] objectForKey:@"appointment"] objectForKey:@"appointment_provider"]valueForKey:@"provider"] objectAtIndex:indexPath.row];
    ...
    selectimage.tag=[[[[[[[NSUserDefaults standardUserDefaults]objectForKey:kLoginData] objectForKey:@"appointment"] objectForKey:@"appointment_provider"]valueForKey:@"id"] objectAtIndex:indexPath.row] integerValue]+100;
...
-(IBAction)selectTypeUser:(UIButton*)sender
{
    ...
    {
        if([sender.titleLabel.text integerValue]==[[[[[[[NSUserDefaults standardUserDefaults]objectForKey:kLoginData] objectForKey:@"appointment"] objectForKey:@"appointment_provider"]valueForKey:@"id"] objectAtIndex:j] integerValue])
        {
            StatusChange=[[NSString stringWithFormat:@"%d",j] integerValue];
            break;
        }
    }
    NSString *MessageString=[[[[[[NSUserDefaults standardUserDefaults]objectForKey:kLoginData] objectForKey:@"appointment"] objectForKey:@"appointment_provider"]valueForKey:@"provider"] objectAtIndex:StatusChange];
    
    NSLog(@"MessageString=%@",MessageString);
    
    [[NSUserDefaults standardUserDefaults]setObject:MessageString forKey:@"setMedicalProviderValueSelect"];
