...
#import "MedicalTypesViewController.h"

@interface MedicalTypesViewController (){
...
@implementation MedicalTypesViewController
...
-(IBAction)selectTypeUser:(UIButton*)sender
{
    ...
    [[NSUserDefaults standardUserDefaults]setObject:MessageString forKey:@"setMedicalTypeValueSelect"];
